    ...
    try {
      ...
      const nftMetadata = {
        ...
        attributes: [
          ...
          { trait_type: "Commercial Use", value: ((usedLicenseSettings.licensePrice || 0) > 0) ? "Yes" : "No" },
          { trait_type: "AI Learning Allowed", value: usedLicenseSettings.aiLearning ? "Yes" : "No" },
          ...(((usedLicenseSettings.licensePrice || 0) > 0) ? [{ trait_type: "Revenue Share", value: `${usedLicenseSettings.revShare}%` }] : []),
